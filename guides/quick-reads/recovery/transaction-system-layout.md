...
After recovery brings components online individually, they exist in isolation—the [sequencer](../../deep-dives/architecture/data-plane/sequencer.md) can't notify [logs](../../deep-dives/architecture/data-plane/log.md), [proxies](../../deep-dives/architecture/data-plane/commit-proxy.md) can't route to [resolvers](../../deep-dives/architecture/data-plane/resolver.md), and [materializers](../../deep-dives/architecture/data-plane/materializer.md) operate independently. The Transaction System Layout (TSL) phase solves this coordination problem.
