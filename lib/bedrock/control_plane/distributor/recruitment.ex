defmodule Bedrock.ControlPlane.Distributor.Recruitment do
  ...
  defp create_materializer_worker(node, tag, context) do
    ...
    # The shard assignment is always recorded alongside any per-worker
    # policy params (e.g. "idle_timeout") so the worker can later be
    # identified (`:shard_id` info fact) and re-adopted after an epoch
    # change.
