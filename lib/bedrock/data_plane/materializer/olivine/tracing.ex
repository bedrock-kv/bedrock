defmodule Bedrock.DataPlane.Materializer.Olivine.Tracing do
  @moduledoc false
  ...
  defp handler_id, do: "bedrock_trace_data_plane_materializer_olivine"
  ...
  def start do
    :telemetry.attach_many(
      ...
      [
        ...
        [:bedrock, :materializer, :transaction_processing_start],
        [:bedrock, :materializer, :transaction_processing_complete],
        [:bedrock, :materializer, :transaction_timeout_scheduled],
        [:bedrock, :materializer, :read_operation_complete],
        [:bedrock, :materializer, :window_advanced]
      ],
  ...
  def log_event(:window_advanced, measurements, metadata) do
    worker_id = Map.get(metadata, :worker_id) || Map.get(metadata, :materializer_id, "unknown")
  ...
  defp debug(message) do
    Logger.debug("Bedrock Materializer Olivine: #{message}", ansi_color: :magenta)
  end

  @spec info(String.t()) :: :ok
  defp info(message) do
    Logger.info("Bedrock Materializer Olivine: #{message}", ansi_color: :magenta)
  end
end
