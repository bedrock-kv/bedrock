defmodule Bedrock.Service.ManifestTest do
  ...
  defp storage, do: Bedrock.DataPlane.Materializer.Olivine
  ...
  describe "load_from_file/1 field validation errors" do
    ...
    test "handles nil params correctly", %{tmp_dir: tmp_dir} do
      ...
      json =
        ~s({"cluster": "test_cluster", "id": "test_id", "worker": "Bedrock.DataPlane.Materializer.Olivine", "params": null})
    ...
    test "fails when params field is invalid type", %{tmp_dir: tmp_dir} do
      ...
      json =
        ~s({"cluster": "test_cluster", "id": "test_id", "worker": "Bedrock.DataPlane.Materializer.Olivine", "params": "invalid"})
